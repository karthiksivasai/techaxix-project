      ...
      <div className="container-responsive">
          ...
          {services.map((service, index) => (
            ...
            >
              <CardContent className="relative p-5 sm:p-6 md:p-7 lg:p-8 h-full flex flex-col">
                ...
                <p className="text-muted-foreground text-fluid-sm sm:text-fluid-base leading-relaxed mb-4 text-center flex-grow">
                  {service.description}
                </p>
        ...
        <div className="text-center">
          <Button
            variant="brand"
            size="lg"
            className="btn-responsive-lg px-8 sm:px-10 md:px-12 py-4 sm:py-5 md:py-6 font-semibold rounded-2xl shadow-2xl hover:shadow-brand-blue-light/40 transform hover:scale-105 transition-all duration-300 bg-gradient-to-r from-brand-blue-light to-accent hover:from-accent hover:to-brand-blue-light"
            asChild
          >
